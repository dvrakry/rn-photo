...
const PHOTO_URL =
  'https://firebasestorage.googleapis.com/v0/b/rn-photo-b328b.firebasestorage.app/o/profile.png?alt=media';
...
export const onAuthStateChanged = (callback) => {
  onAuthStateChangedFirebase(getAuth(), callback);
};
